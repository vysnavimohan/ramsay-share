...
dbutils.widgets.text("app_name", "ramsay-shift-cover", "5. Databricks App name (<=30 chars)")
# Fixed (not widgets): LLM endpoint = databricks-gpt-oss-120b; teardown safety = ramsay_health.
